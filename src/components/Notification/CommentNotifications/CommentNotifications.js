...
import { styles } from './CommentNotifications.styles'
export function CommentNotifications(props) {
        ...
        >
            <View style={styles.leftContent}>
                ...
                <View style={styles.contentInfo}>
                    ...
                    <Text style={styles.text} numberOfLines={3}> {notification.comment}</Text>
